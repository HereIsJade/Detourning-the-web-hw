...
import random
import sys
# url="//cdn.shutterstock.com/shutterstock/videos/4722743/preview/stock-footage-close-up-of-beautiful-teen-mouth-eating-tomato-stock-video-hd-macro-of-girl-enjoying-tasting-tom.mp4"

def download_file(url):
    local_filename = url.split('/')[-1]
    # prevent repetitive downloads
